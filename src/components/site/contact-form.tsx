...
export function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-[38rem]">
      ...
      <button
        type="submit"
        className="group mt-7 inline-flex items-center gap-2.5 rounded-md bg-ink px-7 py-4 text-[14.5px] font-medium text-ink-foreground transition-colors hover:bg-brand"
      >
